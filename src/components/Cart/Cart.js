...
const Cart = (props) => {
  ...
  const cartModalContent = (
    <React.Fragment>
      {cartItems}
        <AvailableDiscounts onDiscount={cartItemDiscountHandler}
/>
  ...
  const isSubmittingModalContent = <Typography> Sending order data...</Typography>;

  const didSubmitModalContent = (
    <React.Fragment>
      <Typography>Your order is coming soon!</Typography>
      <div className={classes.actions}>
